                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <table id="example1" name="example1"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th bgcolor="#ffffff">
                                                    <font color="#000000">NO_TELP</font>
                                                </th>
                                                <th bgcolor="#ffffff">
                                                    <font color="#000000">FOTO_KTP</font>
                                                </th>
                                                <th bgcolor="#ffffff">
                                                    <font color="#000000">LAMPIRAN</font>
                                                </th>
                     ...
                     $con = mysqli_connect('localhost','root','','skripsi');
                      $query = "SELECT * FROM tb_kontrak";

                            $sql_kontrak = mysqli_query($con, $query) or die (mysqli_error($con));

                            if (mysqli_num_rows($sql_kontrak) > 0 )
                            {
                             while($data = mysqli_fetch_array($sql_kontrak))
                             {
                                  ?>
                                            <tr>
                                                <td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#0000CD;">
                            <h4 class="modal-title">
                                <font color="#ffffff"><i class="fas fa-user-circle"></i> Tambah Data Kontrak</font>
                            </h4>
                        </div>
                        <form class="form-horizontal" action="tambahkontrak.php" method="POST" id="peranan">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-info">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-12 control-label">foto
                                                    ktp</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" name="foto_ktp"
                                                        id="foto_ktp" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail3"
                                                    class="col-sm-12 control-label">lampiran</label>
                                                <div class="col-sm-12">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#860a0e;">
                    <h4 class="modal-title">
                        <font color="#ffffff"><i class="fas fa-edit"></i> Edit Pengguna</font>
                    </h4>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <input type="hidden" class="form-control" name="ided" id="ided">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="namaed" id="namaed" required>
                                        </div>
                                    </div>
                                </div>
